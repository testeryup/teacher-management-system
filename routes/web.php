...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Routes for both admin and department head
    ...
    Route::middleware(['role:department_head'])->prefix('department-head')->group(function () {
        Route::get('/dashboard', [DepartmentHeadController::class, 'dashboard'])->name('department_head.dashboard');
        Route::get('/teachers', [DepartmentHeadController::class, 'teachers'])->name('department_head.teachers');
        Route::get('/classrooms', [DepartmentHeadController::class, 'classrooms'])->name('department_head.classrooms');
    });
});
